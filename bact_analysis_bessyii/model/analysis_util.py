...
>>>>>>> 111e526 (Saving current state)
    ...
    for measurement_point in magnet_measurement_data:
        ...
        x_values.append(
            MeasuredValues(
                OrderedDictmpl(
                    zip([bpm["name"] for bpm in measurement_point.bpm], x_data)
                )
            )
        )
        y_values.append(
            MeasuredValues(
                OrderedDictmpl(
                    zip([bpm["name"] for bpm in measurement_point.bpm], y_data)
                )
            )
        )
